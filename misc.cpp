...
/// engine_info() returns the full name of the current Isoquant version. This
/// will be either "Isoquant <Tag> DD-MM-YY" (where DD-MM-YY is the date when
/// the program was compiled) or "Isoquant <Version>", depending on whether
/// Version is empty.
